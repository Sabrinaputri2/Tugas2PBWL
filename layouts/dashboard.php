...
<head>
	...
	<title>TUGAS 2 PBWL | Sabrina Putri</title>
	<link rel="shortcut icon" href="<?php echo AST; ?>/img/s.png" type="image/x-icon">
...
<body>
	...
	<aside>
		...
		<header>
			<img src="<?php echo AST; ?>/img/s.png" class="brand">
			<div class="user">Sabrina Putri</div>
		</header>
	...
	<main>
		...
		<footer>
			Copyright &copy; 2023. Designed by Sabrina Putri
		</footer>
	</main>
